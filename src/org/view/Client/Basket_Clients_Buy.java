 ...
 * @author an
 */
public class Basket_Clients_Buy extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Basket_Clients_Buy
     *
     ...
     * @param Status
     */
    public Basket_Clients_Buy(String welcomeMessage, String clientId, String LastName, String FirstName, String username, String Email, String Status) {
        initComponents();
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    try {
                        ...
                        List<Basket_mod> basket = controller.getClientsPurchaseBasket(Integer.parseInt(clientId));
                        ...
                        if (bas != null) {
                            ...
                            int option = JOptionPane.showOptionDialog(Basket_Clients_Buy.this,
                                    panel,
                            ...
                            JOptionPane.showMessageDialog(Basket_Clients_Buy.this, "Erreur : la transaction sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(Basket_Clients_Buy.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    public void populateTable() {
        ...
        boolean NoSellBasket = controller.hasNoOrders(Integer.parseInt(clientId));
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoSellBasket) {
            String emptyMessage = "Panier d'achat vide.";
            ...
            List<Basket_mod> BasketList = controller.getClientsPurchaseBasket(Integer.parseInt(clientId));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Basket_Clients_Buy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Basket_Clients_Buy(finalMessage, "", "", "", "", "", "").setVisible(true);
            }
        });
    }
