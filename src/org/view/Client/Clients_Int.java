 ...
 * @author an
 */
public class Clients_Int extends javax.swing.JFrame {
     ...
     * @param Status
     */
    public Clients_Int(String welcomeMessage, String clientId, String LastName, String FirstName, String username, String Email, String Status) {
    ...
    private String fetchFullName() {
        String fullName = controller.fetchClientsFullName(username); // Exemple avec ID ou une autre source
    ...
    public void updateAdminName() {
        ...
        if (welcomeMessage == null || welcomeMessage.isEmpty()) {
            ...
            jLabel7.setText("Bienvenue, Nom inconnu"); // Affiche un message par défaut
        } else {
            // Si welcomeMessage a une valeur
            jLabel7.setText(welcomeMessage); // Mettez à jour l'étiquette avec le message
        }
    ...
    private void initComponents() {
        ...
        jLabel7.setFont(new java.awt.Font("MathJax_SansSerif", 1, 36)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText(welcomeMessage);

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/images/l3.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        String username = "client"; // Remplacez par la logique pour obtenir le nom d'utilisateur
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clients_Int.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Clients_Int(finalMessage, "", "", "", "", "", "").setVisible(true);
            }
        });
    }
