 ...
 * @author an
 */
public class List_SellVehicles extends javax.swing.JFrame {
    ...
    /**
     * Creates new form List_SellVehicles
     *
     ...
     * @param Status
     */
    public List_SellVehicles(String welcomeMessage, String clientId, String LastName, String FirstName, String username, String Email, String Status) {
        initComponents();
                    ...
                    try {
                        ...
                        if (veh != null) {
                            ...
                            int option = JOptionPane.showOptionDialog(
                                    List_SellVehicles.this,
                                    panel,
                                    "Détails du véhicule",
                                    JOptionPane.DEFAULT_OPTION,
                                    JOptionPane.INFORMATION_MESSAGE,
                                    null,
                                    new Object[]{"Acheter", "Annuler"},
                                    "Annuler"
                            );
                            ...
                            switch (option) {
                                case 0: // "Supprimer"
                                    ...
                                    String checkResult = controller.checkSellBasket(bas);
                                    if (checkResult.contains("dépasse la limite")) {
                                        JOptionPane.showMessageDialog(
                                                List_SellVehicles.this,
                                                "Vous avez dépassez la limite autorisée pour l'achat d'un véhicule (1), pour plus d'informations veuillez contacter le service á la clientèle.",
                                                "Limite atteinte",
                                        ...
                                        if (added) {
                                            JOptionPane.showMessageDialog(
                                                    List_SellVehicles.this,
                                                    "Véhicule acheté avec succès !"
                                            );
                                        } else {
                                            JOptionPane.showMessageDialog(
                                                    List_SellVehicles.this,
                                                    "Erreur lors de l'achat du véhicule.",
                                                    "Erreur",
                            ...
                            JOptionPane.showMessageDialog(List_SellVehicles.this, "Erreur : le véhicule sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(List_SellVehicles.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    private void initComponents() {
        ...
        setTitle("Liste des Véhicules á vendre");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(List_SellVehicles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new List_SellVehicles(finalMessage, "", "", "", "", "", "").setVisible(true);
            }
        });
    }
