 ...
 * @author an
 */
public class All_Vehicles extends javax.swing.JFrame {
    ...
    /**
     * Creates new form All_Vehicles
     *
     * @param welcomeMessage
     */
    public All_Vehicles(String welcomeMessage) {
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    try {
                        List<Vehicles_mod> vehicules = controller.getAllVehicles();
                        ...
                        if (veh != null) {
                            ...
                            Object[] options = (status == 1)
                                    ? new Object[]{"Supprimer", "À louer", "Modifier", "Annuler"}
                                    : new Object[]{"Supprimer", "À vendre", "Modifier", "Annuler"};
                            ...
                            switch (option) {
                                ...
                                case 1: // "À louer" ou "À vendre"
                                    if (status == 1) {
                                        ...
                                        JOptionPane.showMessageDialog(All_Vehicles.this, "Véhicule loué avec succès !");
                                    } else {
                                        controller.SellVehicles(veh);
                                        JOptionPane.showMessageDialog(All_Vehicles.this, "Véhicule mis en vente avec succès !");
                                    }
                                    populateTable();
                                    break;
                            ...
                            JOptionPane.showMessageDialog(All_Vehicles.this, "Erreur : le véhicule sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(All_Vehicles.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    public void populateTable() {
        boolean NoVehicles = controller.NoVehicles();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoVehicles) {
            String emptyMessage = "Il n'y a pas de véhicules, vérifier la corbeille.";
            ...
            List<Vehicles_mod> vehiclesList = controller.getAllVehicles();  // Fetch all people from the controller
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(All_Vehicles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new All_Vehicles(finalMessage).setVisible(true);
            }
        });
    }
