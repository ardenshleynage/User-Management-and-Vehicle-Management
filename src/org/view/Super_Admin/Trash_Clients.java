 ...
 * @author an
 */
public class Trash_Clients extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Trash_Clients
     *
     * @param welcomeMessage
     */
    public Trash_Clients(String welcomeMessage) {
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    List<Users_mod> clients = controller.getTrashClient();
                    usr = clients.get(selectedRow);
                    ...
                    if (usr != null) {
                        ...
                        String message = String.format(
                                "Nom : %s\nPrénom : %s\nnom d'utilisateur : %s\nE-Mail : %s\nLast Login : %s",
                                lname, fname, username, mail, last_login
                        );
                        ...
                        switch (option) {
                            case 0: // "Supprimer"
                                DeletePeoplesQuestion();
                                break;
                            case 1: // "Autoriser"
                                RestoreClientsQuestion(usr);
                                break;
                            case 2: // "Modifier"
                                break;
                        }
                    } else {
                        JOptionPane.showMessageDialog(Trash_Clients.this, "Erreur : le client sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
    ...
    private void DeletePeoplesQuestion() {
        // Show a dialog with Yes and No options
        int option = JOptionPane.showOptionDialog(
                null,
                "Voulez-vous réellement supprimez le client définitivement ?",
                "Confirmation",
    ...
    private void RestoreClientsQuestion(Users_mod usr) {
        // Show a dialog with Yes and No options
        int option = JOptionPane.showOptionDialog(
                null,
                "Voulez-vous réellement Restaurez le client ?",
                "Confirmation",
                JOptionPane.YES_NO_OPTION,
                JOptionPane.QUESTION_MESSAGE,
                null,
    ...
    private void handleDeletePeoples() {
        boolean success = controller.SureErasePeoples(usr);

        if (success) {
            JOptionPane.showMessageDialog(this, "Le client a été supprimés définitivement.", "Information", JOptionPane.INFORMATION_MESSAGE);
            populateTable();
        } else {
    ...
    private void handleRestoreClients(Users_mod usr) {
        boolean success = controller.SureRestoreClients(usr);

        if (success) {
            JOptionPane.showMessageDialog(this, "Le client a été réstaurer.", "Information", JOptionPane.INFORMATION_MESSAGE);
            populateTable();
        } else {
            JOptionPane.showMessageDialog(this, "Erreur lors de la réstauration du client.", "Erreur", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public void populateTable() {
        boolean EmptyTrashClients = controller.EmptyTrashClients();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (EmptyTrashClients) {
            ...
            List<Users_mod> clientList = controller.getTrashClient();  // Fetch all people from the controller
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "id", "Nom", "Prénom", "Nom d'utilisateurs", "E-mail", "Last Login"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Trash_Clients.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Trash_Clients(finalMessage).setVisible(true);
            }
        });
    }
