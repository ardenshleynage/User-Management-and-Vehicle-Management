 ...
 * @author an
 */
public class Block_Clients extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Block_Clients
     *
     * @param welcomeMessage
     */
    public Block_Clients(String welcomeMessage) {
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    List<Users_mod> clients = controller.getBlockClient();
                    ...
                    if (usr != null) {
                        ...
                        switch (option) {
                            ...
                            case 1: // "Autoriser"
                                ...
                                JOptionPane.showMessageDialog(Block_Clients.this, "Client autorisé avec succès !");
                                populateTable();
                                break;
                            case 2: // "Modifier"
                                dispose();
                        ...
                        JOptionPane.showMessageDialog(Block_Clients.this, "Erreur : le client sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
    ...
    public void populateTable() {
        boolean NoBlockClients = controller.NoBlockClients();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoBlockClients) {
            String emptyMessage = "Il n'y a pas de clients bloquer.";
            ...
            List<Users_mod> clientList = controller.getBlockClient();  // Fetch all people from the controller
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Block_Clients.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Block_Clients(finalMessage).setVisible(true);
            }
        });
    }
