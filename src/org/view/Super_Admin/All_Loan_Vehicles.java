 ...
 * @author an
 */
public class All_Loan_Vehicles extends javax.swing.JFrame {
    ...
    /**
     * Creates new form All_Loan_Vehicles
     *
     * @param welcomeMessage
     */
    public All_Loan_Vehicles(String welcomeMessage) {
                        ...
                        if (veh != null) {
                            ...
                            switch (option) {
                                ...
                                case 1: // "À louer" ou "À vendre"
                                    ...
                                    JOptionPane.showMessageDialog(All_Loan_Vehicles.this, "Véhicule loué avec succès !");
                                    populateTable();
                                    break;
                            ...
                            JOptionPane.showMessageDialog(All_Loan_Vehicles.this, "Erreur : le véhicule sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(All_Loan_Vehicles.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    public void populateTable() {
        boolean NoLoanVehicles = controller.NoLoanVehicles();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoLoanVehicles) {
            String emptyMessage = "Il n'y a pas de véhicules á louer.";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(All_Loan_Vehicles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new All_Loan_Vehicles(finalMessage).setVisible(true);
            }
        });
    }
