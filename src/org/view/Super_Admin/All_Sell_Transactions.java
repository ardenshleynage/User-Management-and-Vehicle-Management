 ...
 * @author an
 */
public class All_Sell_Transactions extends javax.swing.JFrame {
    ...
    /**
     * Creates new form All_Transactions
     *
     * @param welcomeMessage
     */
    public All_Sell_Transactions(String welcomeMessage) {
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    try {
                        List<Basket_mod> basket = controller.getAllSellBasket();
                        ...
                        if (bas != null) {
                            ...
                            int option = JOptionPane.showOptionDialog(All_Sell_Transactions.this,
                                    panel,
                                    "Détails de la tansactions",
                                    JOptionPane.DEFAULT_OPTION,
                                    JOptionPane.INFORMATION_MESSAGE,
                                    null,
                                    new Object[]{"Supprimer", "Location", "Annuler"},
                                    "Retour"
                            );
                            ...
                            switch (option) {
                                ...
                                case 1: // "À louer" ou "À vendre"
                                    controller.LoanTransactions(bas);
                                    JOptionPane.showMessageDialog(All_Sell_Transactions.this, "Transaction loué avec succès !");
                                    populateTable();
                                    break;
                                case 2:
                                    break;
                            ...
                            JOptionPane.showMessageDialog(All_Sell_Transactions.this, "Erreur : la transaction sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(All_Sell_Transactions.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    public void populateTable() {
        boolean NoSellBasket = controller.NoSellBasket();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoSellBasket) {
            String emptyMessage = "Il n'y a pas de transactions de vente, vérifier la corbeille.";
            ...
            List<Basket_mod> BasketList = controller.getAllSellBasket();  // Fetch all people from the controller
    ...
    private void initComponents() {
        ...
        setTitle("Transactions de ventes");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(All_Sell_Transactions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new All_Sell_Transactions(finalMessage).setVisible(true);
            }
        });
    }
