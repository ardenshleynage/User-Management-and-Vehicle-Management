 ...
 * @author an
 */
public class Allow_Clients extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Allow_Clients
     *
     * @param welcomeMessage
     */
    public Allow_Clients(String welcomeMessage) {
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    List<Users_mod> clients = controller.getActiveClient();
                    ...
                    if (usr != null) {
                        ...
                        switch (option) {
                            case 0: // "Supprimer"
                                controller.SureDeletePeoples(usr);
                                DeletePeoplesQuestion();
                                break;
                            case 1: // "bloquer"
                                controller.BlockClients(usr);
                                JOptionPane.showMessageDialog(Allow_Clients.this, "Client bloqué avec succès !");
                                populateTable();
                                break;
                            case 2: // "Modifier"
                                dispose();
                        ...
                        JOptionPane.showMessageDialog(Allow_Clients.this, "Erreur : le client sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
    ...
    public void populateTable() {
        boolean NoAllowClients = controller.NoAllowClients();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoAllowClients) {
            String emptyMessage = "Il n'y a pas de clients autoriser.";
            ...
            List<Users_mod> clientList = controller.getActiveClient();  // Fetch all people from the controller
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Allow_Clients.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Allow_Clients(finalMessage).setVisible(true);
            }
        });
    }
