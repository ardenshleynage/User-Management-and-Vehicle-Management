 ...
 * @author an
 */
public class All_Trash_Transactions extends javax.swing.JFrame {
    ...
    /**
     * Creates new form All_Trash_Transactions
     *
     * @param welcomeMessage
     */
    public All_Trash_Transactions(String welcomeMessage) {
        ...
        jTable2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow >= 0 && SwingUtilities.isLeftMouseButton(e)) {
                    try {
                        List<Basket_mod> basket = controller.getAllTrashBasket();
                        ...
                        if (bas != null) {
                            ...
                            int option = JOptionPane.showOptionDialog(All_Trash_Transactions.this,
                                    panel,
                            ...
                            switch (option) {
                                ...
                                case 1: // "À louer" ou "À vendre"
                                    RestoreTransactionsQuestion(bas);
                                    break;
                                case 2:
                                    break;
                            }
                        } else {
                            JOptionPane.showMessageDialog(All_Trash_Transactions.this, "Erreur : la transaction sélectionné n'a pas pu être trouvé.", "Erreur", JOptionPane.ERROR_MESSAGE);
                        }
                    } catch (Exception ex) {
                        JOptionPane.showMessageDialog(All_Trash_Transactions.this, "Erreur lors de la récupération des données : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        });
    ...
    public void populateTable() {
        boolean NoLoanBasket = controller.NoTrashBasket();
        DefaultTableModel model = (DefaultTableModel) jTable2.getModel();
        model.setRowCount(0);

        if (NoLoanBasket) {
            String emptyMessage = "Corbeille vide.";
            ...
            List<Basket_mod> BasketList = controller.getAllTrashBasket();  // Fetch all people from the controller
    ...
    private void DeleteTransactionsQuestion(Basket_mod bas) {
        ...
        int option = JOptionPane.showOptionDialog(
                null,
                "Voulez-vous réellement supprimez définitivement cette tansaction ?",
                "Confirmation",
    ...
    private void handleDeleteTransactions(Basket_mod bas) {
        boolean success = controller.SureEraseTransactions(bas);

        if (success) {
            JOptionPane.showMessageDialog(this, "La transaction a été supprimés définitivement.", "Information", JOptionPane.INFORMATION_MESSAGE);
            populateTable();
        } else {
            JOptionPane.showMessageDialog(this, "Erreur lors de la suppresion définitive de la transaction.", "Erreur", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void RestoreTransactionsQuestion(Basket_mod bas) {
        // Show a dialog with Yes and No options
        int option = JOptionPane.showOptionDialog(
                null,
                "Voulez-vous réellement Restaurez cette transaction ?",
                "Confirmation",
                JOptionPane.YES_NO_OPTION,
                JOptionPane.QUESTION_MESSAGE,
                null,
    ...
    private void handleRestoreTransactions(Basket_mod bas) {
        boolean success = controller.SureRestoreTransactions(bas);

        if (success) {
            JOptionPane.showMessageDialog(this, "La transaction a été restaurer définitivement.", "Information", JOptionPane.INFORMATION_MESSAGE);
            populateTable();
        } else {
            JOptionPane.showMessageDialog(this, "Erreur lors de la restauration de la transaction.", "Erreur", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Transactions corbeille");
        setResizable(false);
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/java_swing/Parking_Project/src/org/images/trash_sub.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(All_Trash_Transactions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new All_Trash_Transactions(finalMessage).setVisible(true);
            }
        });
    }
